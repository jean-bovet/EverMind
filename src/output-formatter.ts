 ...
 * @param width - Width of the line (auto-detects if not provided)
 * @param char - Character to use (default: ─)
 */
export function horizontalLine(width: number | null = null, char: string = box.horizontal): string {
 ...
 */
export function createBox(content: string, options: CreateBoxOptions = {}): string {
 ...
 * @param width - Width of the header (auto-detects if not provided)
 */
export function stepHeader(stepNumber: number, description: string, width: number | null = null): string {
  const actualWidth = width !== null ? width : getTerminalWidth();
 ...
 * @param width - Width of the line (auto-detects if not provided)
 */
export function stepItem(text: string, width: number | null = null): string {
  const actualWidth = width !== null ? width : getTerminalWidth();
 ...
 * @param width - Width of the footer (auto-detects if not provided)
 */
export function stepFooter(durationMs: number, width: number | null = null): string {
  const actualWidth = width !== null ? width : getTerminalWidth();
 ...
 * @param maxChars - Maximum characters to show
 * @param width - Width of the box (auto-detects if not provided)
 */
 ...
 * @param width - Width of the box (auto-detects if not provided)
 */
export function formatAIResults(
  title: string,
  description: string,
  tags: string[],
  width: number | null = null
